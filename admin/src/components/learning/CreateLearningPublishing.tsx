...
interface CreateLearningPublishingProps {
  control: ReturnType<typeof useCreateLearningForm>['control'];
  register: ReturnType<typeof useCreateLearningForm>['register'];
  errors: any;
}

export const CreateLearningPublishing = ({
  control,
  errors,
}: CreateLearningPublishingProps) => {
  return (
    <div className='flex flex-col gap-5 justify-center p-6'>
      ...
      <div className='flex gap-4 items-center'>
        <div className='flex-1'>
          <p className='font-[inter] font-medium text-[14px] text-[#808080] mb-1'>
            DATE
          </p>
          <Controller
            control={control}
