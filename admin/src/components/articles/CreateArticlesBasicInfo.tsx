...
interface CreateArticleBasicInfoProps
...
export const CreateArticleBasicInfo = ({
  control,
  register,
  errors,
  watch,
  ...
  return (
    <div className='flex flex-col gap-5 justify-center p-6'>
      <div className='flex flex-col gap-1'>
        ...
        />
        {errors.headline && <p className='text-red-500 text-sm'>Required</p>}
      </div>
