...
import type { LearningFilters } from "@/api/learning";
...
export const useLearningFilters = () => {
  const { data: categoriesData, isLoading: categoriesLoading } =
    useCategoriesQuery({ section: "Learning", limit: 1000 });
  ...
  // Define filter options for learning
