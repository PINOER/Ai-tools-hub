...
export const useLearningFormState = () => {
  const [selectedTab, setSelectedTab] = useState(CREATE_LEARNING_DIALOG_TABS.basic_info);
  const [finalLearningDetails, setFinalLearningDetails] = useState<any>(null);
