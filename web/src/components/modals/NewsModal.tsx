            ...
            <div className="flex flex-col justify-center flex-1 ml-2 gap-0.5">
              {[...Array(5)].map((_, i) => (
                <div
                  ...
                  style={{
                    height: "1px",
                    background: `linear-gradient(to right, #34C759, #FFFFFF00, transparent)`,
              ...
              <div className="flex gap-2">
                {news.newsTags && news.newsTags.length > 0 ? (
                  news.newsTags.map((tag, index) => (
                    <span
                      key={index}
                      className="px-[8px] py-[4px] border border-[#F2F2F2] text-gray-700 rounded-[9px] font-[inter] text-[15px] font-medium"
                    >
                      {tag.tag.name}
                    </span>
                  ))
