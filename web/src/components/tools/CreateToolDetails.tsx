...
export const CreateToolDetails = ({
  ...
  // Custom option creator for ReactSelect
  ...
  return (
    <div className='flex flex-col gap-5 justify-center px-6 mt-[40px]'>
      ...
      <div className='flex flex-col gap-1'>
        <p className='font-Nunito font-semibold text-[14px] text-[#4D4D4D]'>Key Features * (One per line)</p>
        <Textarea
          placeholder='Type'
          {...register('features', {
      ...
      <div className='flex flex-col gap-1'>
        <p className='font-Nunito font-semibold text-[14px] text-[#4D4D4D]'>Use cases * (One per line)</p>
        <Textarea
          placeholder='Type'
          {...register('use_cases', {
            required: 'Use cases are required',
          })}
        />
        {errors.use_cases && (
