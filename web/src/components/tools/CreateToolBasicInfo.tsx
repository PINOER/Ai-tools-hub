...
import { Input } from '@/components/toolUi/input';
import ReactSelect from 'react-select';
import { Checkbox } from '@/components/toolUi/checkbox';
  ...
  return (
    <div className='flex flex-col gap-5 justify-center px-6'>
      ...
      <div className='flex flex-col gap-1'>
        ...
        <div className='flex gap-3'>
          ...
          <button
            ...
            onClick={verifyUrl}
            disabled={!isUrlValid}
            className={`rounded-lg w-1/2 md:w-1/6 whitespace-nowrap text-[13px] md:text-[15px] flex items-center justify-center text-white py-1 ${isUrlValid ? 'bg-black cursor-pointer' : 'bg-gray-400 cursor-not-allowed'
              }`}
          >
            Verify URL
      ...
      <div className='flex flex-col md:flex-row gap-4 '>
        <div className='flex flex-col gap-1 w-full md:w-3/6'>
      ...
      <div className='border border-[#F2F2F2] bg-[#4D4D4D] flex gap-2 items-center rounded-[9px] w-fit px-2 py-1'>
        <Controller
          control={control}
          name='is_unique'
          render={({ field }) => (
        ...
        />
        <label htmlFor='confirmation' className='font-[inter] font-medium text-[15px] text-white'>
